...
def generate_plan(month: int, year: int, focus: str = "", events: list = None,
                  trends_context: str = "") -> str:
    ...
    Parameters:
        ...
        trends_context — สรุปเทรนด์จาก trend_summarizer (optional)
    """
    ...
    if trends_context:
        extras.append(f"**เทรนด์อุตสาหกรรมล่าสุด (จาก Trend Summarizer):**\n{trends_context}")
